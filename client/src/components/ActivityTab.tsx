// // src/components/ActivityTab.tsx
...
// import TaskRow from "../pages/App/tasks/TaskRow"; // Component to render each task row
// import EditTaskModal from "./EditTaskModal"; // Modal for editing tasks
// import {
//   PieChart,
//   Pie,
//   Cell,
...
// /** Represents an Assigned Member in a Task */
// interface AssignedMember {
//   _id: string;
//   firstName: string;
//   lastName: string;
//   email?: string;
//   role?: string; // 'leader' or 'employee'
// }
...
//   projectClientName: string; // e.g., "Acme Inc."
//   projectDepartments: string[]; // e.g., ["Development", "Marketing"]
//   projectBudget: string; // e.g., "$10,000"
...
//  * ----------------------------- */
// const ActivityTab: React.FC<ActivityTabProps> = ({ project }) => {
//   /** Task-Level States */
...
//         console.log("ActivityTab -> fetchTasks -> response:", response.data);

//         if (response.data.tasks && Array.isArray(response.data.tasks)) {
//           setTasks(response.data.tasks);
//         } else {
//           setTasksError("Unexpected data format received.");
